...
# MESA
read -rp "Instalar drivers de video a MESA Freeworld? (S/N): " MESA
if [[ $MESA =~ ^[Ss]$ ]]; then
...
alternatives --set java /usr/lib/jvm/java-25-amazon-corretto/bin/java
alternatives --set javac /usr/lib/jvm/java-25-amazon-corretto/bin/javac
